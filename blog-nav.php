...
<nav class="pt-3 d-none d-xl-block">
    <div class="container">
        <div class="d-flex justify-content-between">
            <div>
                <a href="#"><img src="<?php echo get_bloginfo('template_url') ?>/img/typo.png" alt="logo" width="200"></a>
            </div>
            <div>
        ...
        <div class="d-flex justify-content-between">
            ...
            <div>
                <a href="" class="btn btn-outline-blue mx-1">تماس با کلینیتیک</a>
                <a href="" class="btn btn-blue mx-1">صفحه اینستاگرام <img style="height:20px" class="pl-2" src="<?php echo get_bloginfo('template_url') ?>/svg/instagram.svg"></a>
            </div>
        </div>
        <hr class="mt-2 pb-2">
    </div>
